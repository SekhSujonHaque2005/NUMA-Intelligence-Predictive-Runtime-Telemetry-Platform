 ...
 public:
  ...
  class WithAsyncMethod_SendMetrics : public BaseClass {
   ...
   public:
    ...
    ::grpc::Status SendMetrics(::grpc::ServerContext* /*context*/, const ::runtime::Metrics* /*request*/, ::runtime::Metrics* /*response*/) override {
      abort();
  ...
  class ExperimentalWithCallbackMethod_SendMetrics : public BaseClass {
   ...
   public:
    ...
    virtual ::grpc::ServerUnaryReactor* SendMetrics(
      ::grpc::CallbackServerContext* /*context*/, const ::runtime::Metrics* /*request*/, ::runtime::Metrics* /*response*/)
    #else
    virtual ::grpc::experimental::ServerUnaryReactor* SendMetrics(
      ::grpc::experimental::CallbackServerContext* /*context*/, const ::runtime::Metrics* /*request*/, ::runtime::Metrics* /*response*/)
    #endif
      { return nullptr; }
  };
  #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
