...
Metrics::Metrics(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:runtime.Metrics)
}
Metrics::Metrics(const Metrics& from)
  ...
  // @@protoc_insertion_point(copy_constructor:runtime.Metrics)
}
...
Metrics::~Metrics() {
  // @@protoc_insertion_point(destructor:runtime.Metrics)
  SharedDtor();
...
void Metrics::Clear() {
// @@protoc_insertion_point(message_clear_start:runtime.Metrics)
...
::PROTOBUF_NAMESPACE_ID::uint8* Metrics::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:runtime.Metrics)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:runtime.Metrics)
  return target;
}

size_t Metrics::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:runtime.Metrics)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:runtime.Metrics)
  GOOGLE_DCHECK_NE(&from, this);
  const Metrics* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<Metrics>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:runtime.Metrics)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:runtime.Metrics)
    MergeFrom(*source);
  }
}

void Metrics::MergeFrom(const Metrics& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:runtime.Metrics)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:runtime.Metrics)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:runtime.Metrics)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
